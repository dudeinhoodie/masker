...
var phones_2 = require("../constants/device-types");
var PhoneFactory = /** @class */ (function () {
    ...
    PhoneFactory.prototype.create = function (phoneType) {
        var phone;
        switch (phoneType) {
            case phones_2.DEVICE_TYPES.iphone_x: {
                phone = phones_1.IPHONE_X;
            }
            case phones_2.DEVICE_TYPES.iphone_8: {
                phone = phones_1.IPHONE_8;
            }
            case phones_2.DEVICE_TYPES.iphone_8_gold: {
                phone = phones_1.IPHONE_8_GOLD;
            }
            case phones_2.DEVICE_TYPES.iphone_8_red: {
                phone = phones_1.IPHONE_8_RED;
            }
            case phones_2.DEVICE_TYPES.iphone_8_silver: {
                phone = phones_1.IPHONE_8_SILVER;
            }
            case phones_2.DEVICE_TYPES.iphone_8_space_gray: {
